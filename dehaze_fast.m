...
%dehazing the image using dark channel
...
dark_channel = get_dark_channel(image, win_size); %using dark channel function

atmosphere = get_atmosphere(image, dark_channel); %using get atmosphere function
